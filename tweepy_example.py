...
# uprint(type(public_tweets)," is the type of publictweets")

# for tweet in public_tweets:
#     uprint("\n*** type of the tweet object that is included ***\n")
#     uprint(type(tweet),"type of one tweet") 
...
# uprint(single_tweet.keys())

# ## Well, some of these look interesting.
# ## For example,
# uprint("\nHere's the text of the tweet:")
# uprint(single_tweet["text"])
# uprint("\n")
# uprint("Here are the # of favorites of that tweet:")
# uprint(single_tweet["favorite_count"])
...
uprint(type(results), "is the type of the results variable") 

## OK, it's a dictionary. What are its keys?
uprint(results.keys())

# ## That 'statuses' key looks interesting.
# uprint(type(results["statuses"]), "is the type of results['statuses']")
# ## OK, that's a list! Hmm. What's the type of the first element in it?
# uprint(type(results["statuses"][0]), "is the type of the first element in the results")
